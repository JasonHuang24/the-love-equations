...
- 2026-07-31 · [lab-gate-marriage-morphology-red-manifest.md](lab-gate-marriage-morphology-red-manifest.md) **LIVE** — C1 red frozen: `marry\w*` misses married AND marries; broad fix measured and rejected (37 passages, retains the merger metaphor trap), narrowed participant-anchored fix measured at 3 passages / 1 credible + 44 weak crossings, all gains
