...
The model's out-of-sample roster rank correlation is **ρ=0.215** and its within-sex top-vs-bottom-quartile AUC is **0.647** (42 low / 48 high). That is the honest discrimination baseline. A monotone display remap cannot improve either number; it can only redistribute the visible 1–10 values.
...
| Roster canonical portraits (independent editorial labels) | 166 | 0.215 [0.070, 0.362] | 0.236 | 0.647 (42/48) | 0.581 (n=5915) | 0.598 (n=4828) |
...
- Displayed score: median 6.22, p10 4.14, p90 7.18.
- Editorial label: median 7.20, p10 4.00, p90 9.00.
- Display minus editorial label: mean -0.90, median -1.08, MAE 1.79.
...
| --- | ---: | ---: | ---: | ---: |
| f | 84 | 0.192 | 0.625 | 0.587 (n=2361) |
| m | 82 | 0.222 | 0.683 | 0.608 (n=2467) |
